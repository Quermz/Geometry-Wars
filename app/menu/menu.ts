...
import { Laser } from "app/player/laser/laser.js";
import { Particle } from "app/particles/particles.js";
import { Shape } from "app/shape/shape.js";
...
class Menu {
  ...
  gameOverMenu: PIXI.Container;
  gameOverMenuOpen: boolean;
  music: any;
  constructor(
  ...
  openGameOverMenu(app: PIXI.Application) {
  ...
  letter(text: string, arrow = false) {
